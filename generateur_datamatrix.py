...
# -*- coding: utf-8 -*-
"""
Générateur de Data Matrix 2D - Format 116 DOCE
...
def creer_datamatrix(data, taille=150):
    ...
    try:
        ...
        img_array = img_array.reshape((encoded.height, encoded.width))
        ...
        # Créer une image de secours en cas d'erreur
        img = Image.new('RGB', (taille, taille), 'white')
        draw = ImageDraw.Draw(img)
        draw.rectangle([0, 0, taille-1, taille-1], outline='black', width=2)
        draw.text((10, taille//2), "ERREUR", fill='red')
        return img
...
def main():
    ...
    """
    print("🚀 Générateur de Data Matrix 2D - Format 116 DOCE")
    print("=" * 55)
    print("📋 Configuration:")
    ...
    try:
        ...
        print("   • Correction d'erreur intégrée")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("💡 Vous pouvez maintenant utiliser les Data Matrix générés.")
        print("🔍 Les Data Matrix peuvent être lus avec tout lecteur compatible ISO/IEC 16022.")
    else:
        print("\n⚠️  Le script a rencontré des erreurs.")
        print("💡 Vérifiez que la bibliothèque pylibdmtx est correctement installée.")