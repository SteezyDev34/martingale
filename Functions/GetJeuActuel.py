        ...
        try:
            ...
            try:
                ...
                if int(config.set_actuel) == 1:
                    jeu_actuel_player1 = \
                        config.jeu_actuel[1].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[0]
                    jeu_actuel_player2 = \
                        config.jeu_actuel[1].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[1]
                    config.jeu_actuel = [int(jeu_actuel_player1.text), int(jeu_actuel_player2.text)]
                elif int(config.set_actuel) == 2:
                    jeu_actuel_player1 = \
                        config.jeu_actuel[2].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[0]
                    jeu_actuel_player2 = \
                        config.jeu_actuel[2].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[1]
                    config.jeu_actuel = [int(jeu_actuel_player1.text), int(jeu_actuel_player2.text)]
                elif int(config.set_actuel) == 3:
                    jeu_actuel_player1 = \
                        config.jeu_actuel[3].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[0]
                    jeu_actuel_player2 = \
                        config.jeu_actuel[3].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[1]
                    config.jeu_actuel = [int(jeu_actuel_player1.text), int(jeu_actuel_player2.text)]
                elif int(config.set_actuel) == 4:
                    jeu_actuel_player1 = \
                        config.jeu_actuel[4].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[0]
                    jeu_actuel_player2 = \
                        config.jeu_actuel[4].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[1]
                    config.jeu_actuel = [int(jeu_actuel_player1.text), int(jeu_actuel_player2.text)]
                elif int(config.set_actuel) == 5:
                    jeu_actuel_player1 = \
                        config.jeu_actuel[5].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[0]
                    jeu_actuel_player2 = \
                        config.jeu_actuel[5].find_elements(By.CLASS_NAME, config.classes['jeu_cell'][config.site_type])[1]
                    config.jeu_actuel = [int(jeu_actuel_player1.text), int(jeu_actuel_player2.text)]
                else:
                    print('no score')
                    config.jeu_actuel = savedjeu
