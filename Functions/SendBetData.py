...
def SendBetData(driver):
    ...
    try:
        ...
        cote_globale = modal.find_element(By.XPATH, "//span[contains(text(), 'Cote globale')]/following-sibling::div/span").text
        type_pari = modal.find_element(By.XPATH, "//span[contains(text(), 'Type de pari')]/following-sibling::div/span").text
        mise = modal.find_element(By.XPATH, "//span[contains(text(), 'Mise')]/following-sibling::div/span").text
        gains_potentiels = modal.find_element(By.XPATH, "//span[contains(text(), 'Gains potentiels')]/following-sibling::div/span").text
        ...
        api_url = "http://p-com.studio/api/save_bet"+config.scriptType+"/"
