...
from Functions.GetJsonData import getPerte, delPerte, DispatchPerte, SendGlobalPerte
...
def all_script(driver):
    ...
    while (winmatch <= 0 and not config.error):
        ...
        while not result and not config.error:
            ...
            elif (config.score_actuel == '0:0' and saved_score != win_score0) or (config.score_actuel == '40:40' and saved_score != win_score0):
